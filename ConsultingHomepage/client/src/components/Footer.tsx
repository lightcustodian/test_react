    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ConsultingPro</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Technology Implementation</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p className="mt-4">info@consultingpro.com</p>
              <p>+1 (555) 123-4567</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 ConsultingPro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
